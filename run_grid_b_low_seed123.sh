#!/bin/bash
# Grid-b low range runner: trains b=0.1/0.2/0.3 for seed 123
# Purpose: extend grid search below b=0.5 boundary
# Input: data/scored_data.jsonl (371K docs with q_score)
# Output: output/models/grid_b{B}_seed123/ for b in {0_1, 0_2, 0_3}
...
echo "All grid-b low runs for seed 123 complete at $(date)"
