...
echo "=========================================="
echo "Starting adaptive b* seed=42 at $(date)"
echo "=========================================="

python training/pretrain_weighted.py \
    --data_path data/scored_data.jsonl \
    --output_dir output/models/adaptive_seed42 \
...
echo "Completed adaptive b* seed=42 at $(date)"
