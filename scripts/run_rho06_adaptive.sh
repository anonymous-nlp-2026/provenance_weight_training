#!/bin/bash
# p0_contamination_60_adaptive: rho=0.6 adaptive b*
set -e
...
python training/pretrain_weighted.py \
    ...
    --output_dir output/models/rho06_adaptive_seed42 \
    ...
    --wandb_run_name rho06_adaptive_seed42 \
    --eval_steps 500 \
    --save_steps 500 \
    --logging_steps 10 \
    --bf16 \
...
echo "DONE: rho06_adaptive seed42"
