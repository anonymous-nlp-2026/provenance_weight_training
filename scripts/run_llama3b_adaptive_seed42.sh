#!/bin/bash
# Llama-3.2-3B adaptive tau=0.8 n_min=2 (cross-model validation)
set -e
...
python training/pretrain_weighted.py \
    ...
    --output_dir output/models/llama3b_adaptive_seed${SEED} \
    ...
    --wandb_run_name llama3b_adaptive_seed${SEED} \
    --eval_steps 500 \
    --save_steps 500 \
    --logging_steps 10 \
    --bf16 \
...
echo "DONE: llama3b_adaptive seed${SEED}"
