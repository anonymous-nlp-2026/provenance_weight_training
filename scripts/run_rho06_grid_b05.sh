#!/bin/bash
# p0_contamination_60_grid_b0_5: rho=0.6 grid b=0.5
set -e
...
python training/pretrain_weighted.py \
    ...
    --output_dir output/models/rho06_grid_b0_5_seed42 \
    ...
    --wandb_run_name rho06_grid_b0_5_seed42 \
    --eval_steps 500 \
    --save_steps 500 \
    --logging_steps 10 \
    --bf16 \
...
echo "DONE: rho06_grid_b0.5 seed42"
